...
<body>
	...
	<!-- -------------------------------------------
     ...
     ------------------------------------------------ -->
		...
		<label style="text-align: left;">[지역 관리] > [지역 정보 수정]</label>
		<hr>
				...
				<form action="regionupdate.action" method="post" id="regionForm">
					...
					<div class="form-group">
						...
						<div class="input-group">
							...
							<input type="text" id="regionId" name="regionId" placeholder="지역번호" 
							class="form-control" value="${region.regionId}" readonly="readonly"/>
						</div>

						<div class="input-group">
							<div class="input-group-addon">지역명</div>
							<input type="text" id="regionName" name="regionName" placeholder="지역명" 
							class="form-control" value="${region.regionName }"/>
						</div>
