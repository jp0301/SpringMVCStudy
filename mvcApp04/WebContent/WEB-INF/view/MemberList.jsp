...
<style type="text/css">
	...
	* {line-height: 150%;}
	...
	#customers th, td {text-align: center;}
...
<div>
	<form action="memberinsert.action" method="post" id="memberForm">
		이름 <input type="text" name="name" id="name" class="control txt" required="required">
		<br>
		전화 <input type="text" name="telephone" id="telephone" class="control txt" required="required">
		<br>
