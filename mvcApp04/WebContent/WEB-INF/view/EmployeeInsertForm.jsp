	...
	$(function()
	{
		...
		$("#submitBtn").click(
				function()
				{
					...
					if (parseInt($("#minBasicPay").text()) > parseInt($(
							"#basicPay").val()))
					{
...
<body>
	...
	<!-- -------------------------------------------
     ...
     ------------------------------------------------ -->
		...
		<label style="text-align: left;">[직원 관리] > [직원 리스트]</label>
		<hr>
				...
				<form action="employeeinsert.action" method="post" id="employeeForm">
						...
						<div class="input-group">
							...
							<div class="form-control">
								<input type="radio" value="0" name="lunar" id="lunar0"
									...
									type="radio" value="1" name="lunar" id="lunar1" /> <label
									for="lunar1">음력</label>
							</div>
						</div>
					...
					<div class="input-group">
						...
						<button type="button" class="btn btn-primary btn-lg" id="listBtn"
							onclick="location.href='employeeinsertform.action'">직원
							리스트</button>
					</div>
				</div>
