...
<%
	...
	// 객체(Object, Hashtable를 파일에 쓰기 위해 ObjectOutputStream 객체 생성
	ObjectOutputStream oos = new ObjectOutputStream(fos);
	
	// ObjectOutputStream 을 이용하여 파일에 Object를 써 넣는다.
	oos.writeObject(h);
	...
	// 결과
	// C:\SpringMVCStudy\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\fileSystemApp03\
