...
<%
	...
	try
	{
		...
		//  → 요청으로 넘어온 파일들의 이름을 Enumberation 타입으로 반환
		...
		while(files.hasMoreElements())
		{
			...
			{
				out.println("<h3>- 서버에 저장된 파일명 : " + req.getFilesystemName(name) + "</h3>");
				out.println("<h3>- 업로드한 실제 파일명 : " + req.getOriginalFileName(name) + "</h3>");
